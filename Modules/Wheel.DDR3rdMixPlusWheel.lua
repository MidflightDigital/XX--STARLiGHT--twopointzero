...
local function MoveDifficulty(self,offset,Songs)
	...
	-- Not a group
		...
		self:GetChild("DiffChart"):settext(DiffChartNames[DiffCount]):diffuse(DiffColors[TF_WHEEL.DiffTab[Songs[CurSong][CurDiff]:GetDifficulty()]]):strokecolor(DiffColors[TF_WHEEL.DiffTab[Songs[CurSong][CurDiff]:GetDifficulty()]])
