...
if GAMESTATE:IsHumanPlayer(PLAYER_1) then
	t[#t+1] = loadfile(THEME:GetPathB("ScreenPlayerOptions","underlay/options.lua"))(PLAYER_1);
end;

if GAMESTATE:IsHumanPlayer(PLAYER_2) then
	t[#t+1] = loadfile(THEME:GetPathB("ScreenPlayerOptions","underlay/options.lua"))(PLAYER_2);
end;
