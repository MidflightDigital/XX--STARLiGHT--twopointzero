local t = Def.ActorFrame {
	...
	Def.Sprite{ Texture=THEME:GetPathG("MusicWheelItem","Custom OverPart/A/normal"),
		InitCommand=function(s) s:y(-8):diffuse(color("0,0.7,0.2,1")) end
	};
	Def.Sprite{ Texture=THEME:GetPathG("MusicWheelItem","Custom OverPart/A/normal"),
		InitCommand=function(s) s:y(-8):diffuse(color("#00aa22")):blend(Blend.Add):diffusealpha(0.5):thump():effectclock('beat'):effectmagnitude(1,1.05,1):effectoffset(0.35) end,
		SetMessageCommand=function(self,params)
